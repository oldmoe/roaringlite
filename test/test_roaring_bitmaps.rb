...
class TestRoaringBitmap < Minitest::Test
  ...
  #  result = DB.query_single_splat("SELECT rb_count(rb_and_many(rb_create(1,2,3,4), rb_create(2,3,7,8), rb_create(2,3,8,9)))")
  #  assert_equal 2, result
  #end

  #def test_rb_and_many_with_null
  #  result = DB.query_single_splat("SELECT rb_count(rb_and_many(NULL, rb_create(2,3,7,8), rb_create(2,3,8,9)))")
  #  assert_equal 3, result
  #end
  ...
  #def test_rb_or_many
  #  result = DB.query_single_splat("SELECT rb_count(rb_or_many(rb_create(1,2,3,4), rb_create(2,3,7,8), rb_create(2,3,8,9)))")
  #  assert_equal 7, result
  #end

  #def test_rb_or_many_with_null
  #  result = DB.query_single_splat("SELECT rb_count(rb_or_many(NULL, rb_create(2,3,7,8), rb_create(2,3,8,9)))")
  #  assert_equal 5, result
  #end
